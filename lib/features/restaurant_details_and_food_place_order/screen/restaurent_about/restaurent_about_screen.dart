...
import 'widget/day_and_time.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Big Gardan Salad", style: Theme.of(context).textTheme.headlineSmall),
            ...
            Row(
              children: [
                ...
                Text('Grand City St. 100, New York, United States',
                    style: Theme.of(context).textTheme.bodySmall, overflow: TextOverflow.ellipsis, maxLines: 2)
              ],
            ),
            const Gap(TSizes.spaceBtwItems),
